...
| `CLAUDE.md`, `AGENTS.md` | **Yes** | Main configs |
...
Each gate exists because its absence caused real, repeated problems. See [why these gates exist](docs/guides/why-these-gates.md).
...
| **[Cross-verification](docs/guides/cross-verification.md)** | Orchestrator flows, when to apply, implementation strategies |
| **[Token optimization](docs/guides/token-optimization.md)** | Language strategy, loading hierarchy, design decisions |
| **[How Claude Code works](docs/guides/how-claude-code-works.md)** | Context management, what it can access, implications for agents |
| **[Agent lifecycle](docs/guides/agent-lifecycle.md)** | Ephemeral agents, anti-patterns, context management |
| **[Persistent memory](docs/guides/persistent-memory.md)** | Rules, hooks, Engram, Feature Specs, memory per tool |
| **[Why these gates exist](docs/guides/why-these-gates.md)** | Real error chains that motivated each Quality Gate |
| **[Recommended MCPs](docs/guides/recommended-mcps.md)** | Basic and optional MCPs by stack |
| **[Recommended hooks](docs/guides/recommended-hooks.md)** | Git hooks with Lefthook and Husky |
| **[Recommended workflows](docs/guides/recommended-workflows.md)** | GitHub Actions, branch strategy |
| **[Recommended models](docs/guides/recommended-models.md)** | Model per agent/task, cost strategy, local models |
